...
export const PINNED_PAIRS: { readonly [chainId in ChainId]?: [Token, Token][] } = {
  [ChainId.MAINNET]: [
    [
      new Token(ChainId.MAINNET, '0xAa6ebE41cF57B254920a8484491E05BE74568dB6', 18, 'PAPER', 'TestPaper'),
      new Token(ChainId.MAINNET, '0x7160570BB153Edd0Ea1775EC2b2Ac9b65F1aB61B', 18, 'WETH', 'Wrapped ETH'),
    ],
    [BUSD, USDT],
    [DAI, USDT],
  ],
